...
<html>
    <head>
        <link rel="shortcut icon" href="{{asset('images/untitled.ico')}}">
        <title>UA</title>
        <meta charset="utf-8" />
            ...
            <div class="flex flex-4">
                <div class="box person" data-aos="flip-right" data-aos-delay="50">
                    <div class="image round">
                        <a href="#" class="newA">
                            <img src="{{asset('images/space1.jpg')}}" alt="Person 1" />
                        </a>
                    </div>
                    <a href="#" class="newA">
                ...
                <div class="box person" data-aos="flip-right" data-aos-delay="150">
                    <div class="image round">
                        <a href="#" class="newA">
                            <img src="{{asset('images/robots.jpeg')}}" style="width: 168px; height: 168px;" alt="Person 2" />
                        </a>
                    </div>
                    <a href="#" class="newA">
                        <h3><br>Robotica</h3>
                ...
                <div class="box person" data-aos="flip-right" data-aos-delay="250">
                    <div class="image round">
                        <a href="#" class="newA">
                            <img src="{{asset('images/coding.jpg')}}" style="width: 168px; height: 168px;" alt="Person 2" />
                        </a>
                    </div>
                    <a href="#" class="newA">
                ...
                <div class="box person" data-aos="flip-right" data-aos-delay="350">
                    <div class="image round">
                        <a href="#" class="newA">
                            <img src="{{asset('images/mech.jpg')}}" style="width: 168px; height: 168px;" alt="Person 4" />
                        </a>
                    </div>
                    <a href="#" class="newA">
        ...
        <div class="inner">
            ...
            <div class="flex flex-2" >
                <article data-aos-delay="300" data-aos="fade-up">
                    <div class="image fit">
                        <img src="{{asset('images/lab1.png')}}" style="max-width: 576px; height: auto;" alt="Pic 01" />
                    </div>
                    <header>
                ...
                <article data-aos-delay="300" data-aos="fade-up">
                    <div class="image fit">
                        <img src="{{asset('images/lab2.jpg')}}" style="max-width: 576px; height: auto;" alt="Pic 01" />
                    </div>
                    <header>
